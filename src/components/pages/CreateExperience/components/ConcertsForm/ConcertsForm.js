...
const ConcertsForm = (props) => {
  ...
  const renderSteps = () => {
    switch (progress) {
      ...
      case 8:
        return <ExperienceDate formData={formData} nextStep={handleNextStep} />;
      // case 9:
      //   return (
      //     <Calendar
      //       nextStep={handleNextStep}
    ...
    <div className="classes-form">
      {showProgressBar && (
        <FormProgressBar
          ...
          progressPercentage={`${
            (100 / (formData.category === "single" ? 19 : steps)) * progress
          }%`}
        />
      )}
      {renderSteps()}
