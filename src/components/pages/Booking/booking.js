...
import TestBookingTimePickerNew from "./testBookingTimePickerNew";
        ...
        <div
            ...
            <div
                ...
                <div className="">
                    ...
                    <h4 className="text-center mb-1 mt-3">{getSingleUserExperience?.base_unit_amount}€</h4>
                            ...
                            {(width > 1024 || (width <= 1024)) &&
                                <div
                                            ...
                                            <div className='category-select__categories2'>
                                                <span className="checkbox">
                                                    <span className="wrapper2" onClick={() => setSelectedCategory(2)} style={{
                                                        ...
                                                        <span className='category-name-des'>Unterricht findet persönlich statt </span>
                                                    </span>
                                                </span>
                                                <span className="checkbox">
                                                    <span className="wrapper2" onClick={() => setSelectedCategory(3)} style={{
                                                        ...
                                                        <span className='category-name-des'>Unterricht findet via Video statt</span>
                                                    </span>
                                                </span>
                                            </div>
...

                                    {
                                        progress === 3 &&
                                        <Fragment>
                                            <p className="pt-sm-4 font-weight-bold font-20" style={{ textAlign: width < 768 && 'center' }}>Termin auswählen</p>
                                            <p style={{ textAlign: width < 768 && 'center' }}>Wähle einen Startermin aus TRAINERNAME’s Terminkalender. Dieser Termin wird auch dein genereller Termin nach deiner eingestellten Termin Regelmäßigkeit.</p>
                                            {
                                                false &&
                                                <BookingTimePicker
                                                    width={width}
                                                    handleBookingAppointmentType={(type) => setBookingAppointmentType(type)}
                                                />
                                            }
                                            {/* <BookingTimePickerNew
                                                width={width}
                                                handleBookingAppointmentType={(type) => setBookingAppointmentType(type)}
                                                uid={location.state.uid}
                                            /> */}
                                            <TestBookingTimePickerNew
                                                width={width}
                                                handleBookingAppointmentType={(type) => setBookingAppointmentType(type)}
                                                uid={location.state.uid}
                                            />
                                            <div className="booking-cta-container">
                                                <button
                                                    className="btn btn-primary text-light mt-4 mb-2 py-2 booking-weiter-cta"
                                                    style={{ width: '14rem' }} onClick={() => {
                                                        setProgress(progress + 1)
                                                    }}>Weiter
                                                </button>
                                    ...
                                    {
                                        progress === 4 && <BookingClassLocation
                                            setProgress={() => setProgress(progress + 1)}
                                            handleLessonsAtHomeSelect={(atHome) => setLessonsAtHome(atHome)}
                                        />
                                    }
                                    {
                                        progress === 5 && <BookingSubscription
                                            setProgress={() => setProgress(progress + 1)}
                                            handleBookingDiscount={(discount) => setBookingDiscount(discount)}
                                        />
                                    }
                                    {
                                        progress === 6 && <BookingInstrument
                                            setProgress={() => setProgress(progress + 1)}
