...
const PaymentUpdate = ({ next }) => {
    ...
    let modalContents = (
        <div className="booking-requests__modal px-5" style={{borderRadius:'35px'}}>
            <img src={CreditCard} alt="cashRegister" className="mt-5 mb-2"/>
            <p className="booking-requests__count font-18 mb-1 font-weight-bold mt-2">Aktualisiere deine Zahlungsinfos</p>
            <p>Bitte aktualisiere deine Zahlungsinfos.</p>
            <div className="mb-5">
                <button
