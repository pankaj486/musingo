...
const ExperieceSearchBar = ({ onAddressChange, width, filterPackages, filterPackagesBySecondFilter, instruments }) => {
...
export default ExperieceSearchBar
